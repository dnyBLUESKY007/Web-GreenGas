...
| FAQ | `/faq/` | 常见问题（独立页面） |
| Contact | `/contact/` | FAQ 及 Email、电话、WhatsApp、微信、QQ 等直接联系渠道 |
...
当前处于**第一阶段**：页面骨架与核心组件已搭建，首页、Contact、FAQ 等页面完成改版，三语切换（EN / 中文 / Русский）已接入；部分内容与图片仍为占位素材。后续将替换真实素材、完善视觉细节，并按需完善自动化部署。
